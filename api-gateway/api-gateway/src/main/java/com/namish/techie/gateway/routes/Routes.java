package com.namish.techie.gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> productServiceRoute() {
        return GatewayRouterFunctions.route("product_service")
                .route(RequestPredicates.path("/api/product"), HandlerFunctions.http("http://localhost:8080/product-service"))
    ...
    public RouterFunction<ServerResponse> fallbackRoute() {
        return route(RequestPredicates.GET("/fallbackRoute"),
